...
if (!$action || $action === 'list') {
    if (isset($_GET['pegawai_id']) || isset($_GET['search']) || isset($_GET['jenjang']) || isset($_GET['tahun_lulus'])) {
        ...
        if (!empty($params)) {
            $redirect_url = 'index.php?page=pegawai_pendidikan&' . implode('&', $params);
...
<div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    ...
    <?php
    $createUrl = "index.php?page=pegawai_pendidikan&action=create";
...
<div class="bg-white rounded-2xl shadow-sm p-4 mb-6">
    <form method="GET" class="flex flex-col md:flex-row gap-3">
        <input type="hidden" name="page" value="pegawai_pendidikan">
        <div class="flex-1">
        ...
        <a href="index.php?page=pegawai_pendidikan" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium px-6 py-2 rounded-xl transition-colors inline-flex items-center">
            Reset
        </a>
        <?php endif; ?>
    </form>
                ...
                <div class="p-5">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex space-x-2">
                            <a href="index.php?page=pegawai_pendidikan_berkas&pendidikan_id=<?php echo $pendidikan['id']; ?>"
