...
<div class="bg-white rounded-2xl shadow-sm p-6">
    <form method="POST" class="space-y-6">
        ...
        <div class="flex space-x-3 pt-4 border-t">
            <a href="index.php?page=pegawai_pendidikan_berkas&pendidikan_id=<?php echo $pendidikanId; ?>" class="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-6 rounded-xl transition-colors inline-flex items-center space-x-2">
