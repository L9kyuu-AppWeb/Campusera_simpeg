...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($pegawai_id) || empty($jenjang) || empty($nama_institusi)) {
        ...
        if (!$stmt->fetch()) {
            ...
            if ($status_terakhir) {
                $stmt = $pdo->prepare("UPDATE pendidikan SET status_terakhir = 0 WHERE pegawai_id = ?");
                $stmt->execute([$pegawai_id]);
            }
            ...
            $stmt = $pdo->prepare("
                ...
                (pegawai_id, jenjang, nama_institusi, jurusan, tahun_masuk, tahun_lulus, 
            ...
            if ($stmt->execute([$pegawai_id, $jenjang, $nama_institusi, $jurusan, $tahun_masuk, $tahun_lulus,
                               $no_ijazah, $tanggal_ijazah, $gelar_depan, $gelar_belakang, $status_terakhir])) {
                logActivity($_SESSION['user_id'], 'add_education', "Added education for employee: $pegawai_id");
                setAlert('success', 'Data pendidikan berhasil ditambahkan!');
...
<div class="mb-6">
    <div class="flex items-center space-x-4 mb-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Tambah Data Pendidikan</h1>
            <p class="text-gray-500 mt-1">Tambahkan data pendidikan baru</p>
        </div>
    </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <select name="pegawai_id" required
                    ...
                    <?php foreach ($employees as $employee): ?>
                        <option value="<?php echo $employee['id']; ?>"
                                <?php
                                $selectedValue = isset($_POST['pegawai_id']) ? $_POST['pegawai_id'] :
                                               ($preselectedEmployee ? $preselectedEmployee['id'] : $pegawaiId);
            ...
            <div>
                ...
                <select name="jenjang" required
                    ...
                    <option value="SD" <?php echo (isset($_POST['jenjang']) ? $_POST['jenjang'] : '') === 'SD' ? 'selected' : ''; ?>>SD</option>
                    <option value="SMP" <?php echo (isset($_POST['jenjang']) ? $_POST['jenjang'] : '') === 'SMP' ? 'selected' : ''; ?>>SMP</option>
                    <option value="SMA" <?php echo (isset($_POST['jenjang']) ? $_POST['jenjang'] : '') === 'SMA' ? 'selected' : ''; ?>>SMA</option>
                    <option value="D1" <?php echo (isset($_POST['jenjang']) ? $_POST['jenjang'] : '') === 'D1' ? 'selected' : ''; ?>>D1</option>
                    <option value="D2" <?php echo (isset($_POST['jenjang']) ? $_POST['jenjang'] : '') === 'D2' ? 'selected' : ''; ?>>D2</option>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="nama_institusi" required
                       value="<?php echo isset($_POST['nama_institusi']) ? htmlspecialchars($_POST['nama_institusi']) : ''; ?>"
                       class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            ...
            <div>
                ...
                <input type="number" name="tahun_lulus" min="1900" max="2100"
                       value="<?php echo isset($_POST['tahun_lulus']) ? htmlspecialchars($_POST['tahun_lulus']) : ''; ?>"
                       class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            ...
            <div>
                ...
                <input type="text" name="no_ijazah"
                       value="<?php echo isset($_POST['no_ijazah']) ? htmlspecialchars($_POST['no_ijazah']) : ''; ?>"
                       class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            ...
            <div>
                ...
                <input type="date" name="tanggal_ijazah"
                       value="<?php echo isset($_POST['tanggal_ijazah']) ? htmlspecialchars($_POST['tanggal_ijazah']) : ''; ?>"
                       class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            ...
            <div>
                ...
                <input type="text" name="gelar_depan"
                       value="<?php echo isset($_POST['gelar_depan']) ? htmlspecialchars($_POST['gelar_depan']) : ''; ?>"
                       class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            ...
            <div>
                ...
                <input type="text" name="gelar_belakang"
                       value="<?php echo isset($_POST['gelar_belakang']) ? htmlspecialchars($_POST['gelar_belakang']) : ''; ?>"
                       class="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none">
            </div>
            ...
            <div>
                ...
                <div class="mt-1">
                    <input type="checkbox" id="status_terakhir" name="status_terakhir" value="1"
                           <?php echo (isset($_POST['status_terakhir']) ? $_POST['status_terakhir'] : 0) == 1 ? 'checked' : ''; ?>
