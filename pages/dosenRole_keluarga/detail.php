...
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Detail Keluarga Saya</h1>
    <p class="text-gray-500 mt-1">Informasi lengkap tentang anggota keluarga Anda</p>
</div>
...
<div class="bg-white rounded-2xl shadow-sm overflow-hidden">
    ...
    <div class="p-6">
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium"><?php echo htmlspecialchars($keluarga['status_tanggungan'] ? 'Ya' : 'Tidak'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end space-x-3">
            ...
            <a href="index.php?page=dosenRole_keluarga&action=edit&id=<?php echo $keluarga['id']; ?>" class="px-6 py-2 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition-colors">
                Edit
            </a>
            <?php endif; ?>
        </div>
