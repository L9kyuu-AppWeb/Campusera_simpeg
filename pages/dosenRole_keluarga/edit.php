...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($no_ktp)) {
        ...
        $checkSql = "SELECT id FROM pegawai_keluarga WHERE no_ktp = :no_ktp AND pegawai_id = :pegawai_id AND id != :id";
    ...
    if (empty($errors)) {
        try {
            ...
            if ($stmt->execute()) {
                header("Location: index.php?page=dosenRole_keluarga&action=detail&id=$id&success=Data keluarga berhasil diperbarui");
                exit;
            } else {
...
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Edit Keluarga Saya</h1>
    <p class="text-gray-500 mt-1">Ubah data anggota keluarga Anda</p>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
            ...
            <select name="pendidikan_terakhir"
                ...
                <option value="SD" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'SD') ? 'selected' : ''); ?>>SD</option>
                <option value="SMP" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'SMP') ? 'selected' : ''); ?>>SMP</option>
                <option value="SMA" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'SMA') ? 'selected' : ''); ?>>SMA</option>
                <option value="D1" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'D1') ? 'selected' : ''); ?>>D1</option>
                <option value="D2" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'D2') ? 'selected' : ''); ?>>D2</option>
                <option value="D3" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'D3') ? 'selected' : ''); ?>>D3</option>
                <option value="D4/S1" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'D4/S1') ? 'selected' : ''); ?>>D4/S1</option>
                <option value="S2" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'S2') ? 'selected' : ''); ?>>S2</option>
                <option value="S3" <?php echo ((($_POST['pendidikan_terakhir'] ?? $keluarga['pendidikan_terakhir']) === 'S3') ? 'selected' : ''); ?>>S3</option>
            </select>
        ...
        <div class="md:col-span-2">
            <div class="flex items-start">
                <div class="flex items-center h-5">
                    <input id="status_tanggungan" name="status_tanggungan" type="checkbox" <?php echo (isset($_POST['status_tanggungan']) || !empty($_POST) || $keluarga['status_tanggungan']) ? 'checked' : ''; ?>
