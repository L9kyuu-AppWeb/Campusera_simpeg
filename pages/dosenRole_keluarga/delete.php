...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($deleteStmt->execute()) {
        header("Location: index.php?page=dosenRole_keluarga&success=Data keluarga berhasil dihapus");
        exit;
    } else {
...
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-800">Hapus Keluarga Saya</h1>
    <p class="text-gray-500 mt-1">Konfirmasi penghapusan data anggota keluarga Anda</p>
</div>
