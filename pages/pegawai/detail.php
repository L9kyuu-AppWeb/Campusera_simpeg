    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        <div class="md:w-2/3">
            ...
            <div class="mt-6 flex space-x-3">
                <a href="index.php?page=pegawai&action=edit&id=<?php echo $pegawai['id']; ?>" 
...
<div class="bg-white rounded-2xl shadow-sm p-6">
    ...
    <?php if (count($families) > 0): ?>
        ...
        <div class="mt-4 text-center">
            <a href="index.php?page=pegawai_keluarga&pegawai_id=<?php echo $pegawai['id']; ?>"
    ...
    <?php else: ?>
        <div class="text-center py-8">
            ...
            <div class="mt-6">
                <a href="index.php?page=pegawai_keluarga&action=create&pegawai_id=<?php echo $pegawaiId; ?>"
...
<div class="bg-white rounded-2xl shadow-sm p-6">
    ...
    <?php if (count($educations) > 0): ?>
        ...
        <div class="mt-4 text-center">
            <a href="index.php?page=pegawai_pendidikan&pegawai_id=<?php echo $pegawai['id']; ?>"
               class="text-blue-600 hover:text-blue-800 font-medium">
    ...
    <?php else: ?>
        <div class="text-center py-8">
            ...
            <div class="mt-6">
                <a href="index.php?page=pegawai_pendidikan&action=create&pegawai_id=<?php echo $pegawaiId; ?>"
