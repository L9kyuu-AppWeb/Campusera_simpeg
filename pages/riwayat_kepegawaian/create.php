        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="jenis_perubahan" required
                    ...
                    <option value="pengangkatan" <?php echo (isset($_POST['jenis_perubahan']) && $_POST['jenis_perubahan'] === 'pengangkatan') ? 'selected' : ''; ?>>Pengangkatan</option>
                    <option value="promosi" <?php echo (isset($_POST['jenis_perubahan']) && $_POST['jenis_perubahan'] === 'promosi') ? 'selected' : ''; ?>>Promosi</option>
                    <option value="mutasi" <?php echo (isset($_POST['jenis_perubahan']) && $_POST['jenis_perubahan'] === 'mutasi') ? 'selected' : ''; ?>>Mutasi</option>
                    <option value="pensiun" <?php echo (isset($_POST['jenis_perubahan']) && $_POST['jenis_perubahan'] === 'pensiun') ? 'selected' : ''; ?>>Pensiun</option>
                </select>
            </div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Dokumen SK (Opsional)</label>
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl">
                    <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500">(Kosongkan jika hanya ingin mereferensikan dokumen SK tanpa mengupload file)</p>
                    </div>
                </div>
            </div>
        </div>
