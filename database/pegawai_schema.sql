...
-- Contoh: Menambahkan kolom untuk tracking siapa yang membuat dan mengubah data pegawai
-- ALTER TABLE pegawai ADD COLUMN created_by INT NULL;
-- ALTER TABLE pegawai ADD COLUMN updated_by INT NULL;